...
const ALSApacheSpark = () => {
  ...
  useEffect(() => {
    ...
    axios.get("/als-spark.csv").then((response) => {
    ...
    <div className='view'>
      ...
      <div className='model'>
        <div className='model-info'>
          <span className='model-title'>BPR Implicit</span>
          <div className='model-specs'>
            <div className='model-spec'>
              <span className='title'>RMSE</span>
              <span className='content'>30.9</span>
            </div>
            <div className='model-spec'>
              <span className='title'>FACTOR / REGULARIZATION / ITERATIONS</span>
              <span className='content'>50 / 0.1 / 50</span>
            </div>
            <div className='model-spec'>
